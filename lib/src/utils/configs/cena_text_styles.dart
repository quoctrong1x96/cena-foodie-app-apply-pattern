...
import 'cena_colors.dart';

class CenaTextStyles {
  static const smallDescription = TextStyle(
      fontSize: 14.0, fontWeight: FontWeight.normal, color: Colors.grey);
  static const TextStyle foodPriceNonDiscount = TextStyle(
      fontSize: 16.0, fontWeight: FontWeight.normal, color: Colors.black);
  static const foodPriceDiscount = TextStyle(
      fontSize: 16.0,
      fontWeight: FontWeight.normal,
      color: Colors.grey,
      decoration: TextDecoration.lineThrough);
  static const foodPrice = TextStyle(
      fontSize: 16.0, fontWeight: FontWeight.bold, color: CenaColors.primary);
  static const foodName = TextStyle(
  ...
  //s17
  static final blackS17 = black.copyWith(fontSize: 17);
  static final blackS17Bold = blackS16.copyWith(fontWeight: FontWeight.bold);
  static final blackS17W800 = blackS16.copyWith(fontWeight: FontWeight.w800);
  ...
  static final whiteS17 = white.copyWith(fontSize: 17);
  static final whiteS17Bold = whiteS17.copyWith(fontWeight: FontWeight.bold);
  static final whiteS17W800 = whiteS17.copyWith(fontWeight: FontWeight.w800);
  ...
  ///Tint
  static const tint = TextStyle(color: CenaColors.secondary);
