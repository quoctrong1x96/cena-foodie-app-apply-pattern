...
import '../../../models/voucher/voucher_free_ship.dart';
import '../../../models/voucher/voucher_subtract.dart';
...
class CheckOutPage extends StatelessWidget {
  ...
  Widget _buildDetailOrder(BuildContext context, Store store, int finalTotal) {
    ...
    List<ProductCart> listProduct = cardBloc.product
                      ...
                      child: Row(
                        ...
                        children: [
                          Row(
                            children: [
                              Image.network(
                                  URLS.BASE_URL + listProduct[i].imageProduct,
                                  height: 20,
                                  width: 20,
                                  fit: BoxFit.contain),
                              ...
                              CenaTextDescription(
                                  text:
                                      '${listProduct[i].quantity} x ${listProduct[i].nameProduct}',
              ...
              builder: (_, state) => state.address!.id == -1
                  ...
                  : FutureBuilder<Address?>(
                      future: userController.getAddressById(
                          state.user!.uid!, state.address!.id),
