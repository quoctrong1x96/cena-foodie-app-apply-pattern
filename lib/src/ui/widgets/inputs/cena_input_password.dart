...
class CenaInputPassword extends StatelessWidget {
                  ...
                  return Column(
                    children: [
                      ...
                      Text(
                        isValid,
                        style:
                            CenaTextStyles.blackS12.copyWith(color: Colors.red),
                      ),
