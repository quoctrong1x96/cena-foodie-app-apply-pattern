...
class _ClientHomePageState extends State<ClientHomePage>
  ...
  Future<void> storeFetchPerPage() async {
    ...
    UiResponse<List<Store>> list = await _storeService.getNearby(
        limit: whatIsPaginationOf(stores) * storesPerLoading,
        offset: storesPerLoading,
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                ...
                                image: CachedNetworkImageProvider(
                                    ImagesUltils.getImageApiUrl(authBloc
                                        .state.user!.image
                                        .toString())))),
                      ),
                      ...
                      child: CenaRowStore(
                        ...
                        onTab: () {
                          ...
                          NavigationUtils.push(
                              ...
                              args: PageArguments(data: {'stores': stores[i]}));
                        },
                      )
