    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            CenaImageCache(
              url: ImagesUltils.getImageApiUrl(product.picture),
              fit: BoxFit.cover,
              height: 100,
              width: 100,
            ),
        ...
        children: <Widget>[
          Padding(
            ...
            child: Text(
              ...
              style: product.nameProduct!.length < 15
  ...
  Widget _buildPriceDiscount() {
    ...
    if (discount! > 0) {
      String discountString =
          (product.price / 100 * (100 - discount!)).toString();
        ...
        child: Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                discount! > 0
                    ? Text(
                        numberFormat.format(product.price).toString(),
  ...
  Widget _buildAddToCart() {
    return BlocBuilder<CartBloc, CartState>(builder: (context, state) {
      ...
      if (state.products != null) {
        final Cart productCart = state.products!.firstWhere(
            (element) =>
                element.productId == product.id && element.storeId == storeId,
            orElse: () => Cart(
                storeId: storeId,
        ...
        children: <Widget>[
          quantity > 0
              ? GestureDetector(
                  onTap: () {
                    if (quantity > 1) {
                      cartBloc.add(
                          OnDecreaseProductQuantityEvent(product.id, storeId));
                    }
                  },
                  child: Container(
                    height: 25,
          ...
          quantity <= 0
              ...
              : GestureDetector(
                  onTap: () {
                    cartBloc.add(
                        OnIncreaseProductQuantityEvent(product.id, storeId));
                  },
                  child: Container(
                      height: 25,
                      width: 25,
