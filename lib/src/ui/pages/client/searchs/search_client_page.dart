...
class _SearchClientPageState extends State<SearchClientPage> {
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (value) {
                          ...
                          if (value.isNotEmpty) {
                            _productService.searchByName(productName: value);
                          }
                        },
              ...
              BlocBuilder<ProductsBloc, ProductsState>(
                builder: (_, state) => Expanded(
                    child: (state.searchProduct.isNotEmpty)
                        ? listProducts(state.searchProduct)
                        : _HistorySearch()),
              )
            ],
          ),
  ...
  Widget listProducts(String value) {
    return FutureBuilder<UiResponse<List<Product>>>(
        future: _productService.searchByName(productName: value),
        builder: (context, snapshot) {
          ...
          final listProduct = snapshot.data!.data!;
