...
import 'repositories/entities/address_repository.dart';
import 'repositories/entities/auth_repository.dart';
import 'repositories/entities/category_repository.dart';
import 'repositories/entities/dashboard_repository.dart';
import 'repositories/entities/delivery_repository.dart';
import 'repositories/entities/order_repository.dart';
import 'repositories/entities/product_repository.dart';
import 'repositories/entities/store_repository.dart';
import 'repositories/entities/user_repository.dart';
...
void initLocator() {
  ...
  locator.registerLazySingleton<IDashboardService>(() => DashboardRepository());
